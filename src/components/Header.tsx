...
const Header: FC = () => {
  return (
    <div className="bg-[#1e1e30] text-white p-4">
      <div className="bg-blue-900 p-2 flex flex-col sm:flex-row items-center justify-between">
        <div className="flex items-center space-x-4">
          {icons.map((icon) => (
            <Image
              key={icon.id}
